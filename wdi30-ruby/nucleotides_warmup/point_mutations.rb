...
# puts "Please enter string one: "
# x = gets.chomp.upcase
#
# puts "Please enter string two"
# y = gets.chomp.upcase

def hamming_distance (x, y)
  difference = 0

  x.chars.each_with_index do |letter, index|
    if letter != y[index]
      difference += 1
    end
  end
  puts "The hamming distance between #{x} and #{y} is #{difference}"
end
