...
Activity:
You are to generate a basic "guess my number" game. The computer will pick a
random number between 0 and 10. The user will guess the number until they guess
correctly.

Specification:
The user should be asked to guess a number
If the user's guess is correct, the user should see a congratulatory message
If the user's guess is not correct, the user should be asked to guess the number
again.
...
RAND_NUM = Random.rand 10
#puts "The secret number is #{RAND_NUM}"

print "please make a guess a number from one to ten: "
guess_num = gets.to_i

debug_mode = false

until guess_num == RAND_NUM
  #print "wrong, guess again" if debug_mode
